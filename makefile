...
FILE=lmon.c proc.c display.c collect.c func.c

default:
	gcc -o nmon $(FILE) $(CFLAGS) $(LDFLAGS) -D POWER -D KERNEL_2_6_18 -D RHEL7 -rdynamic
...
nmon_power_rhel7: $(FILE)
	gcc -o nmon_power_rhel7 $(FILE) $(CFLAGS) $(LDFLAGS) -D POWER -D KERNEL_2_6_18 -D RHEL7 -g
